...
//        }
    ...
    static File findNativeLibrary()
    {
        ...
        snappyNativeLibraryPath = "/lib/org/xerial/snappy/native/" + OSInfo.getNativeLibFolderPathForCurrentOS();
    ...
    public static String getVersion()
    {
        ...
        if (versionFile == null) {
            versionFile = SnappyLoader.class.getResource("/lib/org/xerial/snappy/VERSION");
        }
